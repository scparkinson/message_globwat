...
SSP_scenarios = c('SSP1','SSP3') # go through and create a baseline for each scenario
...
for( ssss in SSP_scenarios ) # this should be parrellized
	...
	scenarioName = "baseline_globiomOLD_raw_with_water"
	newscenarioName = "baseline_globiomOLD_raw_with_water_test"
